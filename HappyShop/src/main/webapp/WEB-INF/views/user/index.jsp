...
<div class="row">
	<div id="sidebar" class="span3">
		...
		<div class="well well-small">
			<a href="#"><img src="${url}/img/paypal.jpg"
		...
		<ul class="nav nav-list promowrapper">
			<li>
				<div class="thumbnail">
					<a class="zoomTool" href="product_details.html" title="add to cart"><span
						...
						src="${url}/img/bootstrap-template.png"
			...
			<li>
				<div class="thumbnail">
					<a class="zoomTool" href="product_details.html" title="add to cart"><span
						class="icon-search"></span> QUICK VIEW</a> <img
						src="${url}/img/bootstrap-template.png" alt="bootstrap template">
					<div class="caption">
						<h4>
							<a class="defaultBtn" href="product_details.html">VIEW</a> <span
								class="pull-right">$22.00</span>
		...
		<div class="well np">
			<div id="myCarousel" class="carousel slide homCar">
				<div class="carousel-inner">
					<div class="item">
						<img style="width: 100%"
							src="${url}/img/bootstrap_free-ecommerce.png"
							alt="bootstrap ecommerce templates">
					...
					<div class="item">
						<img style="width: 100%" src="${url}/img/carousel1.png"
							alt="bootstrap ecommerce templates">
						<div class="carousel-caption">
					...
					<div class="item active">
						<img style="width: 100%" src="${url}/img/carousel3.png"
							alt="bootstrap ecommerce templates">
						<div class="carousel-caption">
					...
					<div class="item">
						<img style="width: 100%" src="${url}/img/bootstrap-templates.png"
							...
							<li class="span3">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										...
										src="${url}/img/bootstrap-ring.png" alt="bootstrap-ring"></a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										title="add to cart"><span class="icon-search"></span>
										QUICK VIEW</a> <a href="#" class="tag"></a> <a
										href="product_details.html"><img src="${url}/img/i.jpg"
										alt=""></a>
								</div>
							</li>
							<li class="span3">
								<div class="thumbnail">
									<a class="zoomTool" href="product_details.html"
										title="add to cart"><span class="icon-search"></span>
										QUICK VIEW</a> <a href="#" class="tag"></a> <a
										href="product_details.html"><img src="${url}/img/g.jpg"
										alt=""></a>
								</div>
							</li>
							<li class="span3">
