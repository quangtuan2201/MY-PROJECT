...
<section class="our_client">
	...
	<div class="row">
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/1.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/2.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/3.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/4.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/5.png"></a>
		</div>
		<div class="span2">
			<a href="#"><img alt="" src="${url}/img/6.png"></a>
		</div>
	</div>
</section>
...
<div class="copyright">
	<div class="container">
		<p class="pull-right">
			<a href="#"><img src="${url}/img/maestro.png" alt="payment"></a>
			<a href="#"><img src="${url}/img/mc.png" alt="payment"></a> <a
				href="#"><img src="${url}/img/pp.png" alt="payment"></a> <a
				href="#"><img src="${url}/img/visa.png" alt="payment"></a> <a
				href="#"><img src="${url}/img/disc.png" alt="payment"></a>
		</p>
